        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Toast.makeText(AdminAddCourse.this, "Successfully add the course", Toast.LENGTH_LONG).show();
                } catch (Exception e) {
                    Toast.makeText(AdminAddCourse.this, "Failed to adding the course", Toast.LENGTH_LONG).show();
                }
